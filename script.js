...
function initMenu() {
    ...
    const phrPage = document.getElementById('phr-page');
...
// ... (以下、設定モーダル、アップロード、手入力、API通信、描画関数などは変更なし) ...
// ※ 長くなるため省略しますが、initSettingsModal 以降は以前のコードをそのまま維持してください
// ※ 特に initSettingsModal, initUploadModal, initInputModal, fetchData, renderSalesDashboard, renderPhrDashboard
// ※ これらは全て必要です。
// ↓ 念のため、既存のコードをここに貼り付けます（以前のコードブロックと同じものを使ってください）
